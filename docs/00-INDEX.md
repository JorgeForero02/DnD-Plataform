...
>
> - **Generado sobre el commit** `6f3d141` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1851 (shared 75, api 969, web 807). **Es una cota inferior, no lo
