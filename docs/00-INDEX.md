...
>
> - **Generado sobre el commit** `1d2d450` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2664 (shared 192, api 1334, web 1138). **Es una cota inferior, no lo
