...
>
> - **Generado sobre el commit** `581a77d` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1252 (shared 43, api 641, web 568). **Es una cota inferior, no lo
