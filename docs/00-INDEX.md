...
>
> - **Generado sobre el commit** `fb72ed0` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2833 (shared 192, api 1357, web 1284). **Es una cota inferior, no lo
