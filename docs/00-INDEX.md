...
>
> - **Generado sobre el commit** `41013cd` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1865 (shared 79, api 979, web 807). **Es una cota inferior, no lo
