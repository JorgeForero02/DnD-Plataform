...
>
> - **Generado sobre el commit** `5481225` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1880 (shared 79, api 990, web 811). **Es una cota inferior, no lo
