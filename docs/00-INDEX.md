...
>
> - **Generado sobre el commit** `4af7dad` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2796 (shared 192, api 1357, web 1247). **Es una cota inferior, no lo
