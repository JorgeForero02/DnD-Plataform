...
>
> - **Generado sobre el commit** `2314937` **(rama `3a2/elegir-lanzar-y-usar`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3306 (shared 232, api 1592, web 1482). **Es una cota inferior, no lo
