...
>
> - **Generado sobre el commit** `4104b9b` **(rama `ficha/tanda-2-a-5`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2477 (shared 171, api 1235, web 1071). **Es una cota inferior, no lo
