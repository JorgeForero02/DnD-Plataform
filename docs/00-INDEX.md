...
>
> - **Generado sobre el commit** `298ff95` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1473 (shared 43, api 782, web 648). **Es una cota inferior, no lo
