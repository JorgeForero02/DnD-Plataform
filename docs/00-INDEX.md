...
>
> - **Generado sobre el commit** `1c4d8bb` **(rama `3a2/elegir-lanzar-y-usar`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3484 (shared 232, api 1712, web 1540). **Es una cota inferior, no lo
