...
>
> - **Generado sobre el commit** `bfddc6d` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2001 (shared 86, api 1028, web 887). **Es una cota inferior, no lo
