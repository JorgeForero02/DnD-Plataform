...
>
> - **Generado sobre el commit** `cf9ed68` **(rama `3a2/elegir-lanzar-y-usar`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3343 (shared 232, api 1629, web 1482). **Es una cota inferior, no lo
