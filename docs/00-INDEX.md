...
>
> - **Generado sobre el commit** `d3ea708` **(rama `cierre/antes-de-3a2`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3280 (shared 224, api 1583, web 1473). **Es una cota inferior, no lo
