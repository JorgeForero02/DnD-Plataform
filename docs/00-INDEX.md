...
>
> - **Generado sobre el commit** `8e98606` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1225 (shared 43, api 619, web 563). **Es una cota inferior, no lo
