...
>
> - **Generado sobre el commit** `bcba19a` **(rama `3a2/elegir-lanzar-y-usar`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3290 (shared 224, api 1592, web 1474). **Es una cota inferior, no lo
