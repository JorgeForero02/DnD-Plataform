...
>
> - **Generado sobre el commit** `8b1ae58` **(rama `3a3/la-barra-de-acciones`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3543 (shared 232, api 1726, web 1585). **Es una cota inferior, no lo
