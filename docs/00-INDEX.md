...
>
> - **Generado sobre el commit** `d76beeb` **(rama `pnj-del-mundo/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3153 (shared 219, api 1488, web 1446). **Es una cota inferior, no lo
