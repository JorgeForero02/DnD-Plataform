...
>
> - **Generado sobre el commit** `9b4a0a3` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1868 (shared 79, api 981, web 808). **Es una cota inferior, no lo
