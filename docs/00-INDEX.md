...
>
> - **Generado sobre el commit** `92fdcce` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2081 (shared 86, api 1057, web 938). **Es una cota inferior, no lo
