...
>
> - **Generado sobre el commit** `02dc6ad` **(rama `cierre/antes-de-3a2`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3263 (shared 224, api 1583, web 1456). **Es una cota inferior, no lo
