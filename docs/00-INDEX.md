...
>
> - **Generado sobre el commit** `cd4d577` **(rama `ola2/o2`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1792 (shared 75, api 966, web 751). **Es una cota inferior, no lo
