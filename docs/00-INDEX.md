...
>
> - **Generado sobre el commit** `283b468` **(rama `puerta-de-efectos/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3065 (shared 219, api 1453, web 1393). **Es una cota inferior, no lo
