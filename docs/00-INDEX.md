...
>
> - **Generado sobre el commit** `c026e0d` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1457 (shared 43, api 766, web 648). **Es una cota inferior, no lo
