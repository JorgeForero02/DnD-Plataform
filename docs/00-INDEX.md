...
>
> - **Generado sobre el commit** `7c19e3b` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2054 (shared 86, api 1054, web 914). **Es una cota inferior, no lo
