...
>
> - **Generado sobre el commit** `620b969` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2245 (shared 153, api 1118, web 974). **Es una cota inferior, no lo
