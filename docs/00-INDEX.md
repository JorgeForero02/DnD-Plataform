...
>
> - **Generado sobre el commit** `847ec27` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2827 (shared 192, api 1357, web 1278). **Es una cota inferior, no lo
