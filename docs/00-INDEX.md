...
>
> - **Generado sobre el commit** `3aa6c0d` **(rama `3a3/la-barra-de-acciones`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3520 (shared 232, api 1723, web 1565). **Es una cota inferior, no lo
