...
>
> - **Generado sobre el commit** `a06e4b2` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2011 (shared 86, api 1038, web 887). **Es una cota inferior, no lo
