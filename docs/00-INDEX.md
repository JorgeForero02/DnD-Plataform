...
>
> - **Generado sobre el commit** `6253b2f` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2766 (shared 192, api 1354, web 1220). **Es una cota inferior, no lo
