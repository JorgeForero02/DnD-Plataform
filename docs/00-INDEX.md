...
>
> - **Generado sobre el commit** `3ec2d76` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2103 (shared 86, api 1062, web 955). **Es una cota inferior, no lo
