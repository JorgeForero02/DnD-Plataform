...
>
> - **Generado sobre el commit** `235396b` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2591 (shared 192, api 1282, web 1117). **Es una cota inferior, no lo
