...
>
> - **Generado sobre el commit** `5df43db` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1416 (shared 43, api 746, web 627). **Es una cota inferior, no lo
