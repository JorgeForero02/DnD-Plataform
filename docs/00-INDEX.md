...
>
> - **Generado sobre el commit** `b2bfe49` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2031 (shared 86, api 1046, web 899). **Es una cota inferior, no lo
