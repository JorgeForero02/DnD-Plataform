...
>
> - **Generado sobre el commit** `831869d` **(rama `3a2/elegir-lanzar-y-usar`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3293 (shared 227, api 1592, web 1474). **Es una cota inferior, no lo
