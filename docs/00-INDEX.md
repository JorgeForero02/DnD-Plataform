...
>
> - **Generado sobre el commit** `44f33f9` **(rama `ficha/tanda-2-a-5`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2516 (shared 174, api 1261, web 1081). **Es una cota inferior, no lo
