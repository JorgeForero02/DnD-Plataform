...
>
> - **Generado sobre el commit** `37e3e57` **(rama `worktree-agent-aa5c8d841e0920379`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1570 (shared 50, api 846, web 674). **Es una cota inferior, no lo
