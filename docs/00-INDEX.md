...
>
> - **Generado sobre el commit** `cf68768` **(rama `3a3/la-barra-de-acciones`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3530 (shared 232, api 1723, web 1575). **Es una cota inferior, no lo
