...
>
> - **Generado sobre el commit** `49d6e46` **(rama `puerta-de-efectos/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3089 (shared 219, api 1460, web 1410). **Es una cota inferior, no lo
