...
>
> - **Generado sobre el commit** `b2256bb` **(rama `3a2/elegir-lanzar-y-usar`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3413 (shared 232, api 1664, web 1517). **Es una cota inferior, no lo
