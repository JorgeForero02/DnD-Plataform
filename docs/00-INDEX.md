...
>
> - **Generado sobre el commit** `99a1983` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2124 (shared 86, api 1082, web 956). **Es una cota inferior, no lo
