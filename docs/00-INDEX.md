...
>
> - **Generado sobre el commit** `bc98a99` **(rama `reglas-de-la-mesa/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2952 (shared 201, api 1394, web 1357). **Es una cota inferior, no lo
