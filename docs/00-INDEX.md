...
>
> - **Generado sobre el commit** `a1d4a1d` **(rama `carril/c6`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1789 (shared 75, api 966, web 748). **Es una cota inferior, no lo
