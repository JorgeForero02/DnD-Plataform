...
>
> - **Generado sobre el commit** `d37bda3` **(rama `ficha/tanda-2-a-5`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2580 (shared 191, api 1275, web 1114). **Es una cota inferior, no lo
