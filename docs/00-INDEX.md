...
>
> - **Generado sobre el commit** `f378acd` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2067 (shared 86, api 1054, web 927). **Es una cota inferior, no lo
