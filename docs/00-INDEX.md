...
>
> - **Generado sobre el commit** `6110fd9` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2063 (shared 86, api 1054, web 923). **Es una cota inferior, no lo
