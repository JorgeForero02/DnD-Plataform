...
>
> - **Generado sobre el commit** `41feede` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2136 (shared 86, api 1086, web 964). **Es una cota inferior, no lo
