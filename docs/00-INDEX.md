...
>
> - **Generado sobre el commit** `0d26192` **(rama `reglas-de-la-mesa/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2922 (shared 201, api 1388, web 1333). **Es una cota inferior, no lo
