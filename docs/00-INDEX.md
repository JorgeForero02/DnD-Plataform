...
>
> - **Generado sobre el commit** `ae98951` **(rama `hoja/pagina-completa`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2677 (shared 192, api 1338, web 1147). **Es una cota inferior, no lo
