...
>
> - **Generado sobre el commit** `bea4e80` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2183 (shared 91, api 1118, web 974). **Es una cota inferior, no lo
