...
>
> - **Generado sobre el commit** `eafc736` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2033 (shared 86, api 1048, web 899). **Es una cota inferior, no lo
