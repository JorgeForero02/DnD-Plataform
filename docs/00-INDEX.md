...
>
> - **Generado sobre el commit** `52b1ce7` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1933 (shared 86, api 1013, web 834). **Es una cota inferior, no lo
