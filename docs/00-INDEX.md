...
>
> - **Generado sobre el commit** `f632dd9` **(rama `reglas-de-la-mesa/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2893 (shared 201, api 1359, web 1333). **Es una cota inferior, no lo
