...
>
> - **Generado sobre el commit** `e1a8dad` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2142 (shared 86, api 1086, web 970). **Es una cota inferior, no lo
