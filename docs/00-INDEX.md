...
>
> - **Generado sobre el commit** `3ac0546` **(rama `pnj-del-mundo/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3111 (shared 219, api 1481, web 1411). **Es una cota inferior, no lo
