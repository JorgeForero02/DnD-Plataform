...
>
> - **Generado sobre el commit** `4dcb25f` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1679 (shared 68, api 910, web 701). **Es una cota inferior, no lo
