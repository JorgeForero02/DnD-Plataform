...
>
> - **Generado sobre el commit** `1b9d9a0` **(rama `3a3/la-barra-de-acciones`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3517 (shared 232, api 1720, web 1565). **Es una cota inferior, no lo
