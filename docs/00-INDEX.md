...
>
> - **Generado sobre el commit** `2a71e06` **(rama `3a2/elegir-lanzar-y-usar`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3430 (shared 232, api 1673, web 1525). **Es una cota inferior, no lo
