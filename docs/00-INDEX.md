...
>
> - **Generado sobre el commit** `ad786f7` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1734 (shared 75, api 939, web 720). **Es una cota inferior, no lo
