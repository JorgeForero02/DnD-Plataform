...
>
> - **Generado sobre el commit** `eaa333e` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2332 (shared 163, api 1180, web 989). **Es una cota inferior, no lo
