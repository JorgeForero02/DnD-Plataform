...
>
> - **Generado sobre el commit** `10c4d24` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2092 (shared 86, api 1057, web 949). **Es una cota inferior, no lo
