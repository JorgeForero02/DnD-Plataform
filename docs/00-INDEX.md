...
>
> - **Generado sobre el commit** `6dfaf8b` **(rama `cierre/antes-de-3a2`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3272 (shared 224, api 1583, web 1465). **Es una cota inferior, no lo
