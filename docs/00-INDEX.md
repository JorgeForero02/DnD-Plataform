...
>
> - **Generado sobre el commit** `430e703` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2825 (shared 192, api 1357, web 1276). **Es una cota inferior, no lo
