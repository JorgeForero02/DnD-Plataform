...
>
> - **Generado sobre el commit** `84e7239` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2030 (shared 86, api 1046, web 898). **Es una cota inferior, no lo
