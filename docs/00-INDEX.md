...
>
> - **Generado sobre el commit** `d613611` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1922 (shared 79, api 1013, web 830). **Es una cota inferior, no lo
