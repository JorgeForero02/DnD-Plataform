...
| **D-2B-4** | El peso se guarda en **onzas** (`weightOz`, entero) y se enseña en kg; el valor en **cobres** (`costCp`) y se enseña en la moneda que toque | Mismo principio que los pies: unidad íntegra en la base, unidad legible en pantalla. Los pesos del SRD tienen fracciones en libras (¼ de libra) y son enteros en onzas. **La moneda es la excepción** —pesa ⅓ de onza— y su peso se redondea al sumarlo |
