...
>
> - **Generado sobre el commit** `9808e32` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1990 (shared 86, api 1028, web 876). **Es una cota inferior, no lo
