...
>
> - **Generado sobre el commit** `f132faf` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1715 (shared 75, api 939, web 701). **Es una cota inferior, no lo
