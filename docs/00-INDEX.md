...
>
> - **Generado sobre el commit** `ad128ca` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1974 (shared 86, api 1028, web 860). **Es una cota inferior, no lo
