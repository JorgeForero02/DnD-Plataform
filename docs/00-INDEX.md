...
>
> - **Generado sobre el commit** `a23907f` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1790 (shared 75, api 966, web 749). **Es una cota inferior, no lo
