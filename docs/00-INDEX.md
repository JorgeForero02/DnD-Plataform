...
>
> - **Generado sobre el commit** `af3f0b0` **(rama `paso-3a/3a1-el-libro-entra`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3233 (shared 224, api 1553, web 1456). **Es una cota inferior, no lo
