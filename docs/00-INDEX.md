...
>
> - **Generado sobre el commit** `b27a13e` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2774 (shared 192, api 1354, web 1228). **Es una cota inferior, no lo
