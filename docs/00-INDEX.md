...
>
> - **Generado sobre el commit** `0c10d0c` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1539 (shared 43, api 832, web 664). **Es una cota inferior, no lo
