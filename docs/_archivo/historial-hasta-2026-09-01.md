# Historial hasta el 2026-09-01 — CONGELADO

**Congelado el 2026-09-02.** Estas entradas salieron de
[`docs/07-historial.md`](../07-historial.md) cuando pasó de las 600 líneas que fija el
protocolo de documentación. **No se edita nada de aquí**: un documento fechado es un registro,
y corregirlo a posteriori falsifica el archivo.

Cubre desde el arranque del proyecto (2026-07-02) hasta el cierre del 2026-09-01: la fase 0, la
fase 1 completa con su cierre, el endurecimiento de seguridad, la capa de tokens y el reseño
visual. Lo del 2026-09-02 en adelante sigue vivo en `07-historial.md`.

**Aviso para quien lea buscando el estado de hoy: aquí no está.** Esto describe lo que era
cierto entonces. Muchas de estas rutas y decisiones ya no existen — `EditorFicha.tsx`, por
ejemplo, se borró el 2026-09-02.

> **Un único ajuste mecánico al congelar, declarado aquí para que el archivo siga siendo
> transparente:** los enlaces internos decían `./0X-….md` y ahora dicen `../0X-….md`, porque al
> mover este fichero a `_archivo/` bajó un nivel de directorio. **No se tocó ni una palabra del
> contenido.** La ruta se rompió por moverlo, no por caducar.
