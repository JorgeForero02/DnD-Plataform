...
>
> - **Generado sobre el commit** `2d5501b` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1783 (shared 75, api 966, web 742). **Es una cota inferior, no lo
