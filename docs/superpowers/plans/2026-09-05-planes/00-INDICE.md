...
**`main` en `ad128ca`**, árbol limpio, `pnpm verify` en verde. **Nada a medias: no hay rama ni
...
```
09 → 11 → 13 → 14 → 12     (y el 10 al final)

07, 05 y 08 ya están cerrados.
```
