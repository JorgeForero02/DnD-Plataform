...
>
> - **Generado sobre el commit** `d5dee56` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2090 (shared 86, api 1057, web 947). **Es una cota inferior, no lo
