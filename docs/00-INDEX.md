...
>
> - **Generado sobre el commit** `cc32393` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1309 (shared 43, api 683, web 583). **Es una cota inferior, no lo
