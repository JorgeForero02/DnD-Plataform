...
>
> - **Generado sobre el commit** `0776569` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1907 (shared 79, api 1013, web 815). **Es una cota inferior, no lo
