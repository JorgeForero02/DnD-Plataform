...
>
> - **Generado sobre el commit** `8cf9e4a` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2095 (shared 86, api 1057, web 952). **Es una cota inferior, no lo
