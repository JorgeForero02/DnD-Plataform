...
>
> - **Generado sobre el commit** `697b43a` **(rama `interfaz/correcciones-2026-09-19`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3571 (shared 232, api 1726, web 1613). **Es una cota inferior, no lo
