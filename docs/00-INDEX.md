...
>
> - **Generado sobre el commit** `2a8ed37` **(rama `ficha/start-devuelve-get`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2438 (shared 163, api 1227, web 1048). **Es una cota inferior, no lo
