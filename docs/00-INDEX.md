...
>
> - **Generado sobre el commit** `3ced502` **(rama `pnj-del-mundo/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3175 (shared 219, api 1501, web 1455). **Es una cota inferior, no lo
