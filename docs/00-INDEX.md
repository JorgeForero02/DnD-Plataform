...
| `superpowers/specs/2026-09-03-fase-2C-alcance-design.md` | **El alcance de 2C**, escrito sobre lo que hay medido en el código y no sobre lo que el plan prometía: 2B se llevó la mitad. Trae las cinco decisiones que son del autor y **la lista de reglas que hay que contrastar antes de escribirlas** |
