...
>
> - **Generado sobre el commit** `6ac80b7` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1542 (shared 43, api 835, web 664). **Es una cota inferior, no lo
