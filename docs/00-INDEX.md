...
>
> - **Generado sobre el commit** `b0005d7` **(rama `cierre/antes-de-3a2`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3266 (shared 224, api 1583, web 1459). **Es una cota inferior, no lo
