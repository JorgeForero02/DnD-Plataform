...
>
> - **Generado sobre el commit** `f5bede3` **(rama `ficha/tanda-2-a-5`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2495 (shared 171, api 1251, web 1073). **Es una cota inferior, no lo
