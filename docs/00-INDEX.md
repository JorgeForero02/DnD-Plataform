...
>
> - **Generado sobre el commit** `b12f870` **(rama `reglas-de-la-mesa/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2934 (shared 201, api 1388, web 1345). **Es una cota inferior, no lo
