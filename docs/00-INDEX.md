...
>
> - **Generado sobre el commit** `583b545` **(rama `worktree-agent-afdd1e7dec0cc60bd`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1709 (shared 75, api 936, web 698). **Es una cota inferior, no lo
