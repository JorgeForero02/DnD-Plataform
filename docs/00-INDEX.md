...
>
> - **Generado sobre el commit** `5f69786` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1847 (shared 75, api 969, web 803). **Es una cota inferior, no lo
