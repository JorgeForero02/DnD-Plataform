...
>
> - **Generado sobre el commit** `1758c21` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1970 (shared 86, api 1028, web 856). **Es una cota inferior, no lo
