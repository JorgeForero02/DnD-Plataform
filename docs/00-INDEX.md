...
>
> - **Generado sobre el commit** `695d200` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2770 (shared 192, api 1354, web 1224). **Es una cota inferior, no lo
