...
>
> - **Generado sobre el commit** `fc05387` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2035 (shared 86, api 1050, web 899). **Es una cota inferior, no lo
