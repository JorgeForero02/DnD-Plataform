...
>
> - **Generado sobre el commit** `06c3aff` **(rama `reglas-de-la-mesa/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2907 (shared 201, api 1373, web 1333). **Es una cota inferior, no lo
