...
>
> - **Generado sobre el commit** `1b6408e` **(rama `pnj-del-mundo/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3135 (shared 219, api 1488, web 1428). **Es una cota inferior, no lo
