...
>
> - **Generado sobre el commit** `e0e7830` **(rama `pnj-del-mundo/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3102 (shared 219, api 1473, web 1410). **Es una cota inferior, no lo
