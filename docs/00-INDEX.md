...
>
> - **Generado sobre el commit** `8aff6e6` **(rama `hoja/pagina-completa`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2672 (shared 192, api 1338, web 1142). **Es una cota inferior, no lo
