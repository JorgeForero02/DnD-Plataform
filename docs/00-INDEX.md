...
>
> - **Generado sobre el commit** `cbbfebf` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2372 (shared 163, api 1201, web 1008). **Es una cota inferior, no lo
