...
>
> - **Generado sobre el commit** `2bd7769` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2159 (shared 86, api 1099, web 974). **Es una cota inferior, no lo
