...
>
> - **Generado sobre el commit** `4f81464` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2395 (shared 163, api 1202, web 1030). **Es una cota inferior, no lo
