...
>
> - **Generado sobre el commit** `14bbd44` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1966 (shared 86, api 1028, web 852). **Es una cota inferior, no lo
