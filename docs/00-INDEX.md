...
>
> - **Generado sobre el commit** `19a6444` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2324 (shared 161, api 1177, web 986). **Es una cota inferior, no lo
