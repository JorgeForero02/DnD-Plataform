...
>
> - **Generado sobre el commit** `3c2b82d` **(rama `worktree-agent-a68c10ffae5d5762d`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1672 (shared 68, api 906, web 698). **Es una cota inferior, no lo
