...
>
> - **Generado sobre el commit** `10a2eb5` **(rama `pe-1/cierre`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3186 (shared 219, api 1511, web 1456). **Es una cota inferior, no lo
