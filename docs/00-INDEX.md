...
>
> - **Generado sobre el commit** `fa2e963` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2793 (shared 192, api 1354, web 1247). **Es una cota inferior, no lo
