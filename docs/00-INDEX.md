...
>
> - **Generado sobre el commit** `a28f820` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2400 (shared 163, api 1207, web 1030). **Es una cota inferior, no lo
