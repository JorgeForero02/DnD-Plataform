...
>
> - **Generado sobre el commit** `4b050e4` **(rama `reglas-de-la-mesa/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2921 (shared 201, api 1387, web 1333). **Es una cota inferior, no lo
