...
>
> - **Generado sobre el commit** `ae23304` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2874 (shared 192, api 1357, web 1325). **Es una cota inferior, no lo
