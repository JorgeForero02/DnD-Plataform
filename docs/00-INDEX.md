...
>
> - **Generado sobre el commit** `cd4d577` **(rama `ola2/o3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1837 (shared 75, api 966, web 796). **Es una cota inferior, no lo
