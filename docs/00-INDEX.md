...
>
> - **Generado sobre el commit** `0c53b05` **(rama `pnj-del-mundo/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3149 (shared 219, api 1488, web 1442). **Es una cota inferior, no lo
