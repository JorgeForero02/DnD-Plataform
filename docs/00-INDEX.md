...
>
> - **Generado sobre el commit** `df15c30` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2849 (shared 192, api 1357, web 1300). **Es una cota inferior, no lo
