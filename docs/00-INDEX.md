...
>
> - **Generado sobre el commit** `5c410bd` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1594 (shared 54, api 863, web 677). **Es una cota inferior, no lo
