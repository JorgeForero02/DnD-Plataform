...
>
> - **Generado sobre el commit** `197256e` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1860 (shared 79, api 974, web 807). **Es una cota inferior, no lo
