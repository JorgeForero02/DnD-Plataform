...
import { IconoEspada, IconoOjo } from "../../../ui/Iconos";
import { Dialog } from "../../../ui/Dialog";
import { PonerCondicion } from "./PonerCondicion";
import { PonerDano } from "./PonerDano";

/**
 * **Los tres mandos del DM sobre un combatiente** — «Daño», «Condición» y el ojo que abre su
 * hoja —, extraídos (ronda de arreglo 1 sobre la tarea 9b, I-3) porque vivían **idénticos, casi
 * literales**, en `FichaDeElenco.tsx` y en `FichaDePnj.tsx`: la fila de tres botones, el estado
 * de qué cajón está abierto, el `tipoDeDano` que hay que limpiar al cerrar y los tres cajones en
