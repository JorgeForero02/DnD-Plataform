...
>
> - **Generado sobre el commit** `10dd383` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1221 (shared 41, api 617, web 563). **Es una cota inferior, no lo
