...
>
> - **Generado sobre el commit** `3e423d0` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1627 (shared 61, api 878, web 688). **Es una cota inferior, no lo
