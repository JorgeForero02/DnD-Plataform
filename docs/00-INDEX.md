...
>
> - **Generado sobre el commit** `ee4eaa6` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2772 (shared 192, api 1354, web 1226). **Es una cota inferior, no lo
