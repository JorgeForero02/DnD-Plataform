...
>
> - **Generado sobre el commit** `d08029e` **(rama `cierre/antes-de-3a2`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3261 (shared 224, api 1581, web 1456). **Es una cota inferior, no lo
