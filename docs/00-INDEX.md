...
>
> - **Generado sobre el commit** `e2dc957` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2026 (shared 86, api 1046, web 894). **Es una cota inferior, no lo
