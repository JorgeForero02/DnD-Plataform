...
>
> - **Generado sobre el commit** `c8395ec` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2045 (shared 86, api 1054, web 905). **Es una cota inferior, no lo
