...
>
> - **Generado sobre el commit** `80a9243` **(rama `hoja/task-1-token-revocado`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2668 (shared 192, api 1338, web 1138). **Es una cota inferior, no lo
