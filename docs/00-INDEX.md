...
>
> - **Generado sobre el commit** `9751916` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2139 (shared 86, api 1086, web 967). **Es una cota inferior, no lo
