...
>
> - **Generado sobre el commit** `5044507` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1521 (shared 43, api 830, web 648). **Es una cota inferior, no lo
