...
>
> - **Generado sobre el commit** `70b353c` **(rama `1.19b-vestir-pantallas`)** — instantánea de la
...
> - **Pruebas unitarias:** 312 (shared 20, api 92, web 200). Recuento por declaración, no por
