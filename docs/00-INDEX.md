...
>
> - **Generado sobre el commit** `2cd9297` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2441 (shared 163, api 1230, web 1048). **Es una cota inferior, no lo
