...
>
> - **Generado sobre el commit** `5518aec` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2123 (shared 86, api 1082, web 955). **Es una cota inferior, no lo
