...
>
> - **Generado sobre el commit** `75bab98` **(rama `hoja/pagina-completa`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2716 (shared 192, api 1343, web 1181). **Es una cota inferior, no lo
