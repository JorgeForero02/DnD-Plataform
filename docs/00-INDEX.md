...
>
> - **Generado sobre el commit** `d902e23` **(rama `3a2/elegir-lanzar-y-usar`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3398 (shared 232, api 1661, web 1505). **Es una cota inferior, no lo
