...
>
> - **Generado sobre el commit** `bd7060f` **(rama `ficha/tanda-2-a-5`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2546 (shared 184, api 1262, web 1100). **Es una cota inferior, no lo
