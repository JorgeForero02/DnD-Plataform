...
>
> - **Generado sobre el commit** `aa49d43` **(rama `interfaz/correcciones-2026-09-19`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3583 (shared 232, api 1726, web 1625). **Es una cota inferior, no lo
