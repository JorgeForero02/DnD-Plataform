...
>
> - **Generado sobre el commit** `4edc1c8` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2039 (shared 86, api 1054, web 899). **Es una cota inferior, no lo
