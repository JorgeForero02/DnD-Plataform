...
>
> - **Generado sobre el commit** `ff5efa0` **(rama `worktree-agent-ac1b64608e21554d5`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1636 (shared 61, api 887, web 688). **Es una cota inferior, no lo
