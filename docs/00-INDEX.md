...
>
> - **Generado sobre el commit** `090a671` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2051 (shared 86, api 1054, web 911). **Es una cota inferior, no lo
