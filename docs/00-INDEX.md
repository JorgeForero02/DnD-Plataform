...
>
> - **Generado sobre el commit** `fc01106` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2115 (shared 86, api 1074, web 955). **Es una cota inferior, no lo
