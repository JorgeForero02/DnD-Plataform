...
describe("de un suceso del registro a un tipo de mensaje", () => {
  ...
  it("clasifica los 49 tipos de suceso, sin dejarse ninguno", () => {
    ...
    // 2026-09-13): dar XP es un hecho propio de la crónica, y **52 con `NPC_REVEALED` y
    // `NPC_HIDDEN`** (PNJ del mundo y la mesa, 2026-09-14): revelar y ocultar una criatura.
    expect(GAME_EVENT_TYPES).toHaveLength(52);
