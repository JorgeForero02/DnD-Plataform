...
>
> - **Generado sobre el commit** `5b2dba0` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2132 (shared 86, api 1086, web 960). **Es una cota inferior, no lo
