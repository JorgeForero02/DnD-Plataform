...
>
> - **Generado sobre el commit** `afb51de` **(rama `reglas-de-la-mesa/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2912 (shared 201, api 1378, web 1333). **Es una cota inferior, no lo
