...
type Overlay = null | "hoja" | "inventario" | "mundo" | "reincorporar";
  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-bg text-text">
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-s3 p-s3">
        ...
        >
          <ColumnaElenco rol={rol} enCombate={enCombate} onAbrir={abrirFicha} />
      ...
      {overlay === "hoja" && (
        <HojaDePersonaje p={fichaAbierta} onClose={() => setOverlay(null)} />
      )}
      ...
      {dados && <PanelDeDados accion={dados} onCerrar={() => setDados(null)} />}
    </div>
  );
}
