...
>
> - **Generado sobre el commit** `7ff1904` **(rama `hoja/pagina-completa`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2690 (shared 192, api 1338, web 1160). **Es una cota inferior, no lo
