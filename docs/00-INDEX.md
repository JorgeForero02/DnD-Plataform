...
>
> - **Generado sobre el commit** `ea28fff` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2781 (shared 192, api 1354, web 1235). **Es una cota inferior, no lo
