...
>
> - **Generado sobre el commit** `9cabf64` **(rama `3a3/la-barra-de-acciones`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3511 (shared 232, api 1720, web 1559). **Es una cota inferior, no lo
