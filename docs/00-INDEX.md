...
>
> - **Generado sobre el commit** `1628965` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1605 (shared 54, api 863, web 688). **Es una cota inferior, no lo
