...
>
> - **Generado sobre el commit** `6b6026a` **(rama `hoja/pagina-completa`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2687 (shared 192, api 1338, web 1157). **Es una cota inferior, no lo
