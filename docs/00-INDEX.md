...
>
> - **Generado sobre el commit** `135f400` **(rama `3a2/elegir-lanzar-y-usar`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3366 (shared 232, api 1652, web 1482). **Es una cota inferior, no lo
