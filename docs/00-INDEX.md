...
>
> - **Generado sobre el commit** `17a0943` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1534 (shared 43, api 830, web 661). **Es una cota inferior, no lo
