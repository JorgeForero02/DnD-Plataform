...
## Efectos de mesa: la tarjeta y la pantalla reaccionan a lo que pasa (2026-09-15) — en rama `feat/efectos-de-mesa`
...
Revertir — `git revert` de los commits de la rama; ninguna migración. Sin fusionar ni desplegar
al escribir esto: la fusión y el despliegue los decide el autor.
