...
>
> - **Generado sobre el commit** `83e2ec7` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1549 (shared 43, api 835, web 671). **Es una cota inferior, no lo
