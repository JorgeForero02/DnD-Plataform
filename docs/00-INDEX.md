...
>
> - **Generado sobre el commit** `267b063` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2269 (shared 158, api 1137, web 974). **Es una cota inferior, no lo
