...
>
> - **Generado sobre el commit** `dc81dc7` **(rama `hoja/pagina-completa`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2735 (shared 192, api 1354, web 1189). **Es una cota inferior, no lo
