...
>
> - **Generado sobre el commit** `583b545` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1676 (shared 68, api 910, web 698). **Es una cota inferior, no lo
