...
>
> - **Generado sobre el commit** `28e4afb` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2848 (shared 192, api 1357, web 1299). **Es una cota inferior, no lo
