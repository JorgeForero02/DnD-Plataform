...
>
> - **Generado sobre el commit** `c0d8b92` **(rama `paso-3a/3a1-el-libro-entra`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3256 (shared 224, api 1576, web 1456). **Es una cota inferior, no lo
