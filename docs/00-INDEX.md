...
>
> - **Generado sobre el commit** `4945001` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1839 (shared 75, api 966, web 798). **Es una cota inferior, no lo
