...
>
> - **Generado sobre el commit** `33ae26c` **(rama `paso-3a/3a1-el-libro-entra`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3255 (shared 224, api 1575, web 1456). **Es una cota inferior, no lo
