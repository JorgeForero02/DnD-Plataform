...
>
> - **Generado sobre el commit** `c884321` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1931 (shared 86, api 1013, web 832). **Es una cota inferior, no lo
