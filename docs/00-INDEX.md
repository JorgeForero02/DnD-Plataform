...
>
> - **Generado sobre el commit** `197256e` **(rama `plan-04-hilo`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1856 (shared 75, api 971, web 810). **Es una cota inferior, no lo
