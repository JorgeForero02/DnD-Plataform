...
>
> - **Generado sobre el commit** `64330ac` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2845 (shared 192, api 1357, web 1296). **Es una cota inferior, no lo
