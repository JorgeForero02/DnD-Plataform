...
>
> - **Generado sobre el commit** `e402cc1` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1924 (shared 79, api 1013, web 832). **Es una cota inferior, no lo
