...
(PM-1, T3, PE-2 y el caso de la tarea 11, D-CF-87); producción sigue en `4830b8a` y el despliegue lo
lanza el autor.** Queda PM-2 en [06-pendientes.md](./06-pendientes.md). **Y después el paso 3 en
