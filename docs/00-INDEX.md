...
>
> - **Generado sobre el commit** `ef293dc` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2402 (shared 163, api 1209, web 1030). **Es una cota inferior, no lo
