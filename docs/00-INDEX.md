...
>
> - **Generado sobre el commit** `cdf8d00` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2846 (shared 192, api 1357, web 1297). **Es una cota inferior, no lo
