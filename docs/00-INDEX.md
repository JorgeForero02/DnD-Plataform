...
>
> - **Generado sobre el commit** `fb6a601` **(rama `reglas-de-la-mesa/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2951 (shared 201, api 1393, web 1357). **Es una cota inferior, no lo
