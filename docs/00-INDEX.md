...
>
> - **Generado sobre el commit** `6b16804` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2396 (shared 163, api 1203, web 1030). **Es una cota inferior, no lo
