...
>
> - **Generado sobre el commit** `b6fd7ef` **(rama `puerta-de-efectos/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3009 (shared 210, api 1438, web 1361). **Es una cota inferior, no lo
