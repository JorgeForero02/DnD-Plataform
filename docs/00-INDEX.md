...
>
> - **Generado sobre el commit** `25814cb` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2762 (shared 192, api 1354, web 1216). **Es una cota inferior, no lo
