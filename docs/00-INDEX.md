...
>
> - **Generado sobre el commit** `37e3e57` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1555 (shared 43, api 835, web 677). **Es una cota inferior, no lo
