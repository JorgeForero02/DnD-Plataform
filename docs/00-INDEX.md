...
>
> - **Generado sobre el commit** `6ef8c03` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1997 (shared 86, api 1028, web 883). **Es una cota inferior, no lo
