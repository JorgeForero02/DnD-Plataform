# Historial archivado — las tandas por tarea del 2026-09-03 y 04

**Movido desde `07-historial.md` el 2026-09-05**, por su tope de 400 líneas y por su propia regla:
*«se queda un hito por entrega; se archiva el detalle por tarea»*. **Ninguna entrada se ha
reescrito ni resumido** — se mueven enteras, y son tan ciertas como el día que se escribieron.

Los hitos que se quedaron en `07-historial.md`: el reseño de la mesa, lo comprobado en producción
al desplegar 2D, y la auditoría de documentación.
