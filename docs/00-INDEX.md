...
>
> - **Generado sobre el commit** `7591a9e` **(rama `hoja/pagina-completa`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2709 (shared 192, api 1338, web 1179). **Es una cota inferior, no lo
