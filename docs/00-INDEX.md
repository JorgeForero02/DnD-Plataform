...
>
> - **Generado sobre el commit** `37e3e57` **(rama `worktree-agent-acbcef6dbd200acd7`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1577 (shared 43, api 860, web 674). **Es una cota inferior, no lo
