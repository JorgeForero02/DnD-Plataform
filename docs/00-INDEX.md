...
>
> - **Generado sobre el commit** `f6fd6f5` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2403 (shared 163, api 1209, web 1031). **Es una cota inferior, no lo
