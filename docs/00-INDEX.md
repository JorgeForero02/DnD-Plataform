...
>
> - **Generado sobre el commit** `4903c7d` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1544 (shared 43, api 835, web 666). **Es una cota inferior, no lo
