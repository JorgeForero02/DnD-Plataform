...
>
> - **Generado sobre el commit** `f9463c2` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2210 (shared 118, api 1118, web 974). **Es una cota inferior, no lo
