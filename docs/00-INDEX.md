...
>
> - **Generado sobre el commit** `62e3d7b` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2108 (shared 86, api 1067, web 955). **Es una cota inferior, no lo
