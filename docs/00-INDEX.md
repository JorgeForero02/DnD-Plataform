...
>
> - **Generado sobre el commit** `45215da` **(rama `ficha/tanda-2-a-5`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2579 (shared 191, api 1275, web 1113). **Es una cota inferior, no lo
