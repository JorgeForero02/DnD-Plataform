...
>
> - **Generado sobre el commit** `ac38165` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2408 (shared 163, api 1213, web 1032). **Es una cota inferior, no lo
