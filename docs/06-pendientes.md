...
`features/entities/BotonRevelar.tsx:54` es la única definición de `sePuedeRevelar`, y sus tres
consumidores la **importan**: `features/sessions/dm/RevelarAlgo.tsx:4`,
`features/sessions/taller/PrepararSesion.tsx:8` y `pages/EntityDetailPage.tsx:6`. Cero copias del
predicado y cero mutaciones sueltas. **La ficha se tacha sin tocar una línea de código**: la Ola 2
