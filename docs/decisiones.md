...
## Ejecución de 3A.1 (2026-09-14) · [plan](./superpowers/plans/2026-09-14-3a1-el-libro-entra.md) · [constraints](../.superpowers/sdd/2026-09-14-3a1-el-libro-entra/constraints.md) · [ledger](../.superpowers/sdd/2026-09-14-3a1-el-libro-entra/progress.md)
...
| D-CF-93 | **Los rasgos de clase se emparejan por (clase, nivel, posición en la tabla de la clase)** —«El guerrero / Nivel / Rasgos» del SRD español lista los nombres en el mismo orden que el `advancement` de Foundry—, porque un rasgo no tiene huella numérica; los choques van a la misma tabla a mano |
