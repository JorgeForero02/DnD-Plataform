...
>
> - **Generado sobre el commit** `ad580bd` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2778 (shared 192, api 1354, web 1232). **Es una cota inferior, no lo
