...
>
> - **Generado sobre el commit** `2166a4e` **(rama `hoja/pagina-completa`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2723 (shared 192, api 1343, web 1188). **Es una cota inferior, no lo
