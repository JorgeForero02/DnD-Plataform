...
>
> - **Generado sobre el commit** `b9f8931` **(rama `reglas-de-la-mesa/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2965 (shared 201, api 1403, web 1361). **Es una cota inferior, no lo
