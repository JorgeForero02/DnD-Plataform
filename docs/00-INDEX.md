...
>
> - **Generado sobre el commit** `565a19b` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2760 (shared 192, api 1354, web 1214). **Es una cota inferior, no lo
