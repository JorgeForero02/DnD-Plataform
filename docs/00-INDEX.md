...
>
> - **Generado sobre el commit** `d410aab` **(rama `hoja/pagina-completa`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2752 (shared 192, api 1354, web 1206). **Es una cota inferior, no lo
