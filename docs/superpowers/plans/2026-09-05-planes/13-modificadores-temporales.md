...
| ✅ hecho | 2026-09-06 | **Web.** `apps/web/src/features/character-sheet/ModificadoresTemporales.tsx`, montado en `HojaCalculada.tsx`. La traza traduce `temporary:<motivo>` en `character-sheet/vocabulario.ts`; los dos sucesos, en `features/sessions/linea-de-log.ts`. **Commit `bf33b0e`** |
