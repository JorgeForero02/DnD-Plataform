...
>
> - **Generado sobre el commit** `9b48c5d` **(rama `3a3/la-barra-de-acciones`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3522 (shared 232, api 1723, web 1567). **Es una cota inferior, no lo
