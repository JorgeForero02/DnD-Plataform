...
>
> - **Generado sobre el commit** `053cfdc` **(rama `paso-3a/3a1-el-libro-entra`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3224 (shared 224, api 1544, web 1456). **Es una cota inferior, no lo
