...
>
> - **Generado sobre el commit** `fa98dc1` **(rama `hoja/pagina-completa`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2683 (shared 192, api 1338, web 1153). **Es una cota inferior, no lo
