...
>
> - **Generado sobre el commit** `0e40447` **(rama `cierre/antes-de-3a2`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3273 (shared 224, api 1583, web 1466). **Es una cota inferior, no lo
