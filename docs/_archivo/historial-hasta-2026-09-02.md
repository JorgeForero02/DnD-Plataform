# Historial archivado — hasta el 2026-09-02, más el detalle por tarea del 2026-09-03

**Congelado el 2026-09-03. Nada de aquí se edita.** Es un registro de lo que era cierto cuando
se escribió cada entrada, no una descripción del sistema de hoy. Si algo de aquí contradice a
`docs/01`–`09`, **manda `docs/`**.

Continúa a
[`historial-hasta-2026-09-01.md`](./historial-hasta-2026-09-01.md), que cubre desde el arranque
del proyecto hasta el cierre de la fase 1.

**Qué hay aquí, y por qué salió de `07-historial.md`:** el 07 llegó a 2192 líneas, y un
historial que nadie termina de leer no informa a nadie — menos aún a un agente sin memoria que
lo relee en cada sesión y rellena inventando lo que no le cabe. Se movió, **sin reescribir ni
resumir una sola entrada**:

- **Las entradas por tarea del 2026-09-03**: 2B, las seis de 2C, 2D.5 y 2D.6, la adopción de la
  maqueta, el prototipo y los arreglos sueltos. En el 07 se quedaron solo los cinco hitos de ese
  día (fase 2B cerrada, fase 2C cerrada, fase 2C en producción, fase 2D, y la revisión de cierre
  de 2D).
- **Todo el 2026-09-02**: la fase 2A entera tarea a tarea, la ronda de interfaz, la mesa de
  agentes, y la primera puesta en producción de `dnd.supportive.pro`.
- **La bitácora del despliegue del 2026-09-02** que vivía en `docs/03-despliegue.md` bajo «Lo
  comprobado EN PRODUCCIÓN, con su evidencia». Es registro fechado, no procedimiento, y en un
  documento de despliegue obligaba a leer tres tablas de evidencia antes de llegar a los pasos.
...
## Bitácora del despliegue del 2026-09-02 (venía de `docs/03-despliegue.md`)
