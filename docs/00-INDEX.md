...
>
> - **Generado sobre el commit** `2bce0e0` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2764 (shared 192, api 1354, web 1218). **Es una cota inferior, no lo
