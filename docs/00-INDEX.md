...
>
> - **Generado sobre el commit** `4234d52` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1548 (shared 43, api 835, web 670). **Es una cota inferior, no lo
