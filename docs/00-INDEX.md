...
>
> - **Generado sobre el commit** `2929bea` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1396 (shared 43, api 745, web 608). **Es una cota inferior, no lo
