...
>
> - **Generado sobre el commit** `1c8a5be` **(rama `ficha/auth-me-dead-branch`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2443 (shared 163, api 1231, web 1049). **Es una cota inferior, no lo
