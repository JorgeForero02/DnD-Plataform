...
>
> - **Generado sobre el commit** `02e532b` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1367 (shared 43, api 724, web 600). **Es una cota inferior, no lo
