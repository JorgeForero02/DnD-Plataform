...
>
> - **Generado sobre el commit** `6cd63a1` **(rama `3a3/la-barra-de-acciones`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3529 (shared 232, api 1723, web 1574). **Es una cota inferior, no lo
