...
>
> - **Generado sobre el commit** `64a51c2` **(rama `puerta-de-efectos/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3033 (shared 219, api 1453, web 1361). **Es una cota inferior, no lo
