...
>
> - **Generado sobre el commit** `d20550a` **(rama `ficha/grants-members`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2444 (shared 163, api 1232, web 1049). **Es una cota inferior, no lo
