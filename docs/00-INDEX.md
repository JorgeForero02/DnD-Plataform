...
>
> - **Generado sobre el commit** `23f6055` **(rama `plan/poda-desbloqueo`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2436 (shared 163, api 1226, web 1047). **Es una cota inferior, no lo
