...
>
> - **Generado sobre el commit** `d4cc5f7` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1254 (shared 43, api 641, web 570). **Es una cota inferior, no lo
