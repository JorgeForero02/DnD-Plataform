...
>
> - **Generado sobre el commit** `5119c9b` **(rama `hoja/pagina-completa`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2675 (shared 192, api 1338, web 1145). **Es una cota inferior, no lo
