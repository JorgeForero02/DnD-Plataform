...
>
> - **Generado sobre el commit** `f460ea0` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2110 (shared 86, api 1069, web 955). **Es una cota inferior, no lo
