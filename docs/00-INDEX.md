...
>
> - **Generado sobre el commit** `d1cb224` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1637 (shared 61, api 878, web 698). **Es una cota inferior, no lo
