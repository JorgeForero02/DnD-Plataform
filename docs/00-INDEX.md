...
>
> - **Generado sobre el commit** `41ca113` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2404 (shared 163, api 1210, web 1031). **Es una cota inferior, no lo
