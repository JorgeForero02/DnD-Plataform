...
>
> - **Generado sobre el commit** `2fb8eae` **(rama `ficha/tanda-2-a-5`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2554 (shared 184, api 1268, web 1102). **Es una cota inferior, no lo
