...
>
> - **Generado sobre el commit** `8c6f4a0` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1408 (shared 43, api 746, web 619). **Es una cota inferior, no lo
