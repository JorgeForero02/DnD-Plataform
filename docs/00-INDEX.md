...
>
> - **Generado sobre el commit** `09cfba4` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2607 (shared 192, api 1296, web 1119). **Es una cota inferior, no lo
