...
>
> - **Generado sobre el commit** `9cdb639` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2305 (shared 161, api 1158, web 986). **Es una cota inferior, no lo
