...
>
> - **Generado sobre el commit** `ede50af` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1925 (shared 80, api 1013, web 832). **Es una cota inferior, no lo
