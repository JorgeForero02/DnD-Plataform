...
>
> - **Generado sobre el commit** `133c261` **(rama `plan/poda-desbloqueo`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2423 (shared 163, api 1220, web 1040). **Es una cota inferior, no lo
