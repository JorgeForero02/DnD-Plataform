...
>
> - **Generado sobre el commit** `71e2107` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1552 (shared 43, api 835, web 674). **Es una cota inferior, no lo
