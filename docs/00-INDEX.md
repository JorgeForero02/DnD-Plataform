...
>
> - **Generado sobre el commit** `3bf2ed9` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2128 (shared 86, api 1086, web 956). **Es una cota inferior, no lo
