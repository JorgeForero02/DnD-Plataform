...
>
> - **Generado sobre el commit** `37e3e57` **(rama `worktree-agent-ae175711a31ab614f`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1588 (shared 54, api 860, web 674). **Es una cota inferior, no lo
