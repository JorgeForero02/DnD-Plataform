...
>
> - **Generado sobre el commit** `c1677f3` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2782 (shared 192, api 1354, web 1236). **Es una cota inferior, no lo
