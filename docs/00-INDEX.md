...
>
> - **Generado sobre el commit** `dc4d6aa` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1943 (shared 86, api 1013, web 844). **Es una cota inferior, no lo
