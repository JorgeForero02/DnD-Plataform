...
>
> - **Generado sobre el commit** `4c965ed` **(rama `hoja/pagina-completa`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2668 (shared 192, api 1334, web 1142). **Es una cota inferior, no lo
