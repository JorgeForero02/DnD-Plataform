...
>
> - **Generado sobre el commit** `f45b5a6` **(rama `ficha/n4-proposal-rule-name`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2442 (shared 163, api 1230, web 1049). **Es una cota inferior, no lo
