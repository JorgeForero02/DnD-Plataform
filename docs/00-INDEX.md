...
>
> - **Generado sobre el commit** `8d4de37` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2394 (shared 163, api 1201, web 1030). **Es una cota inferior, no lo
