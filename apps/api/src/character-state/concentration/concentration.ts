...
/**
 * La CD de la salvación de concentración para un daño ya aplicado (después de resistencia,
 * vulnerabilidad y PG temporales — el número que de verdad le llegó al personaje).
 */
