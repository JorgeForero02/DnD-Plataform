...
>
> - **Generado sobre el commit** `39094d0` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1759 (shared 75, api 964, web 720). **Es una cota inferior, no lo
