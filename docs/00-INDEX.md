...
>
> - **Generado sobre el commit** `69ea5c6` **(rama `hoja/pagina-completa`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2744 (shared 192, api 1354, web 1198). **Es una cota inferior, no lo
