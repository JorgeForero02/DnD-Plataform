...
>
> - **Generado sobre el commit** `8f36024` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2297 (shared 161, api 1150, web 986). **Es una cota inferior, no lo
