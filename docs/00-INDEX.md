...
>
> - **Generado sobre el commit** `c44c740` **(rama `pnj-del-mundo/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3119 (shared 219, api 1488, web 1412). **Es una cota inferior, no lo
