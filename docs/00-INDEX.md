...
>
> - **Generado sobre el commit** `21a0ca2` **(rama `cierre/antes-de-3a2`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3258 (shared 224, api 1578, web 1456). **Es una cota inferior, no lo
