...
>
> - **Generado sobre el commit** `a52870b` **(rama `ficha/d8-admin-password-reset`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2445 (shared 163, api 1231, web 1051). **Es una cota inferior, no lo
