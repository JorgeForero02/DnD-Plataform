...
>
> - **Generado sobre el commit** `4a75bd3` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2134 (shared 86, api 1086, web 962). **Es una cota inferior, no lo
