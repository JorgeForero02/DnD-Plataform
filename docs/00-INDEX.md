...
>
> - **Generado sobre el commit** `98fa00b` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2018 (shared 86, api 1038, web 894). **Es una cota inferior, no lo
