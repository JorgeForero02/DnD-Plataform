...
>
> - **Generado sobre el commit** `1aba8b2` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1947 (shared 86, api 1013, web 848). **Es una cota inferior, no lo
