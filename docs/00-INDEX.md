...
>
> - **Generado sobre el commit** `3dd2786` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2868 (shared 192, api 1357, web 1319). **Es una cota inferior, no lo
