...
>
> - **Generado sobre el commit** `75f6460` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2084 (shared 86, api 1057, web 941). **Es una cota inferior, no lo
