...
>
> - **Generado sobre el commit** `e9ed5a5` **(rama `hoja/pagina-completa`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2680 (shared 192, api 1338, web 1150). **Es una cota inferior, no lo
