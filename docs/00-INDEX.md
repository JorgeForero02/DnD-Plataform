...
>
> - **Generado sobre el commit** `11c607c` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1877 (shared 79, api 990, web 808). **Es una cota inferior, no lo
