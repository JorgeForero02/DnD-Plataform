...
>
> - **Generado sobre el commit** `d48f268` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1984 (shared 86, api 1028, web 870). **Es una cota inferior, no lo
