...
>
> - **Generado sobre el commit** `333898f` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2407 (shared 163, api 1213, web 1031). **Es una cota inferior, no lo
