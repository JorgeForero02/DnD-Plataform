...
>
> - **Generado sobre el commit** `90e3c0b` **(rama `3a3/la-barra-de-acciones`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3495 (shared 232, api 1720, web 1543). **Es una cota inferior, no lo
