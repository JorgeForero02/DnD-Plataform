...
>
> - **Generado sobre el commit** `a78fce1` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2592 (shared 191, api 1282, web 1119). **Es una cota inferior, no lo
