...
>
> - **Generado sobre el commit** `5055656` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1495 (shared 43, api 804, web 648). **Es una cota inferior, no lo
