...
>
> - **Generado sobre el commit** `ef502b8` **(rama `ficha/tanda-2-a-5`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2519 (shared 174, api 1262, web 1083). **Es una cota inferior, no lo
