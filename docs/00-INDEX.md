...
>
> - **Generado sobre el commit** `ba2ca48` **(rama `puerta-de-efectos/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3044 (shared 219, api 1453, web 1372). **Es una cota inferior, no lo
