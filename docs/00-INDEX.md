...
>
> - **Generado sobre el commit** `3ef461e` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1844 (shared 75, api 966, web 803). **Es una cota inferior, no lo
