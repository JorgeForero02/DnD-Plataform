...
>
> - **Generado sobre el commit** `5081c46` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2113 (shared 86, api 1072, web 955). **Es una cota inferior, no lo
