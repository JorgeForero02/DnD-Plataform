...
>
> - **Generado sobre el commit** `3206331` **(rama `puerta-de-efectos/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2979 (shared 203, api 1415, web 1361). **Es una cota inferior, no lo
