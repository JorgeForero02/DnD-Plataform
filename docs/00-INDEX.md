...
>
> - **Generado sobre el commit** `2f0b376` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2044 (shared 86, api 1054, web 904). **Es una cota inferior, no lo
