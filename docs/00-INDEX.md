...
>
> - **Generado sobre el commit** `c1fbd2e` **(rama `3a3/la-barra-de-acciones`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3498 (shared 232, api 1720, web 1546). **Es una cota inferior, no lo
