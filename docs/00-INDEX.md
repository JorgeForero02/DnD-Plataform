...
>
> - **Generado sobre el commit** `3e35629` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2041 (shared 86, api 1054, web 901). **Es una cota inferior, no lo
