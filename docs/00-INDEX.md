...
>
> - **Generado sobre el commit** `7e0ced2` **(rama `ficha/tanda-2-a-5`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2527 (shared 174, api 1262, web 1091). **Es una cota inferior, no lo
