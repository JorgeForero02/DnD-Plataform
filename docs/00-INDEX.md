...
>
> - **Generado sobre el commit** `232ea04` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1242 (shared 43, api 634, web 565). **Es una cota inferior, no lo
