...
>
> - **Generado sobre el commit** `b7a0987` **(rama `hoja/pagina-completa`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2696 (shared 192, api 1338, web 1166). **Es una cota inferior, no lo
