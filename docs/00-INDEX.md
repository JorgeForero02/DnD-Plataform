...
>
> - **Generado sobre el commit** `d1cb224` **(rama `worktree-agent-ac1b64608e21554d5`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1631 (shared 61, api 882, web 688). **Es una cota inferior, no lo
