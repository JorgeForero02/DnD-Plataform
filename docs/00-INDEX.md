...
>
> - **Generado sobre el commit** `d08d803` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2037 (shared 86, api 1052, web 899). **Es una cota inferior, no lo
