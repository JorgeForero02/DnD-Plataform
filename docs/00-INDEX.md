...
>
> - **Generado sobre el commit** `3bbdb1c` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1873 (shared 79, api 986, web 808). **Es una cota inferior, no lo
