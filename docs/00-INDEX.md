...
>
> - **Generado sobre el commit** `494e64b` **(rama `paso-3a/3a1-el-libro-entra`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3210 (shared 224, api 1530, web 1456). **Es una cota inferior, no lo
