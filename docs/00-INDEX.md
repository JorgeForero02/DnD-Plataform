...
>
> - **Generado sobre el commit** `8a59cc8` **(rama `1.18c-e2e-rate-limit`)** — instantánea de la
...
> - **Pruebas unitarias:** 275 (shared 20, api 92, web 163). Recuento por declaración, no por
