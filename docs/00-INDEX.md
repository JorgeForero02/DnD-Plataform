...
>
> - **Generado sobre el commit** `0595cad` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1655 (shared 61, api 896, web 698). **Es una cota inferior, no lo
