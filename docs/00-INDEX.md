...
>
> - **Generado sobre el commit** `9f23111` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2145 (shared 86, api 1089, web 970). **Es una cota inferior, no lo
