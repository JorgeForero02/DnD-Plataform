...
>
> - **Generado sobre el commit** `4e5e80d` **(rama `ficha/tanda-2-a-5`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2465 (shared 171, api 1235, web 1059). **Es una cota inferior, no lo
