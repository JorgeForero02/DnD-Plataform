...
>
> - **Generado sobre el commit** `fc8b369` **(rama `puerta-de-efectos/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2998 (shared 205, api 1432, web 1361). **Es una cota inferior, no lo
