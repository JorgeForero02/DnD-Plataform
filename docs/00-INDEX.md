...
>
> - **Generado sobre el commit** `53e735e` **(rama `puerta-de-efectos/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3072 (shared 219, api 1460, web 1393). **Es una cota inferior, no lo
