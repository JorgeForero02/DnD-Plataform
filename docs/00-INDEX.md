...
>
> - **Generado sobre el commit** `e258d60` **(rama `plan-06-gestos`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1880 (shared 79, api 981, web 820). **Es una cota inferior, no lo
