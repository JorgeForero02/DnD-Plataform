...
>
> - **Generado sobre el commit** `149bd93` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2087 (shared 86, api 1057, web 944). **Es una cota inferior, no lo
