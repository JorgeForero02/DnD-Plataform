...
>
> - **Generado sobre el commit** `fd83559` **(rama `paso-3a/3a1-el-libro-entra`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3195 (shared 224, api 1515, web 1456). **Es una cota inferior, no lo
