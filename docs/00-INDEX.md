...
>
> - **Generado sobre el commit** `bdf2d0b` **(rama `ficha/tanda-2-a-5`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2479 (shared 171, api 1235, web 1073). **Es una cota inferior, no lo
