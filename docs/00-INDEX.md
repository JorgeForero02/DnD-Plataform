...
>
> - **Generado sobre el commit** `7b2b8c2` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2119 (shared 86, api 1078, web 955). **Es una cota inferior, no lo
