...
>
> - **Generado sobre el commit** `e321c55` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2637 (shared 192, api 1313, web 1132). **Es una cota inferior, no lo
