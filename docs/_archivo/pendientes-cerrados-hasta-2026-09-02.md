# Pendientes ya cerrados, hasta el 2026-09-02 — CONGELADO

**Congelado el 2026-09-02.** Salieron de [`docs/06-pendientes.md`](../06-pendientes.md) porque
ese fichero es **una lista de trabajo, no un cementerio**: el protocolo pide podar lo cerrado.
El detalle de por qué se cerró cada cosa vive en el historial; esto se conserva por si algo
vuelve a abrirse y hace falta saber cómo se cerró la vez anterior.

**No se edita nada de aquí.**
