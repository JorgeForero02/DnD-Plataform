...
>
> - **Generado sobre el commit** `e08aca4` **(rama `plan/poda-desbloqueo`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2437 (shared 163, api 1226, web 1048). **Es una cota inferior, no lo
