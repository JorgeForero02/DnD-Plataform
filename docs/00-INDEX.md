...
>
> - **Generado sobre el commit** `74b206b` **(rama `1.18a-api-security`)** — instantánea de la
...
> - **Pruebas unitarias:** 264 (shared 20, api 81, web 163). Recuento por declaración, no por
