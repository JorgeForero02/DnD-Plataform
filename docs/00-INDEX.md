...
>
> - **Generado sobre el commit** `c390acc` **(rama `interfaz/correcciones-2026-09-19`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3576 (shared 232, api 1726, web 1618). **Es una cota inferior, no lo
