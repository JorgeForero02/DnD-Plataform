...
>
> - **Generado sobre el commit** `001e8b7` **(rama `plan/poda-desbloqueo`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2420 (shared 163, api 1217, web 1040). **Es una cota inferior, no lo
