...
>
> - **Generado sobre el commit** `6bd0389` **(rama `pnj-del-mundo/cierre`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3182 (shared 219, api 1508, web 1455). **Es una cota inferior, no lo
