...
>
> - **Generado sobre el commit** `a0ee667` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1512 (shared 43, api 821, web 648). **Es una cota inferior, no lo
