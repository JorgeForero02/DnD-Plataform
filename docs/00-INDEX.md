...
>
> - **Generado sobre el commit** `9dc5e88` **(rama `3a2/elegir-lanzar-y-usar`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3414 (shared 232, api 1664, web 1518). **Es una cota inferior, no lo
