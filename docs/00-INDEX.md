...
>
> - **Generado sobre el commit** `212eb76` **(rama `hoja/pagina-completa`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2695 (shared 192, api 1338, web 1165). **Es una cota inferior, no lo
