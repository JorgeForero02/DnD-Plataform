...
>
> - **Generado sobre el commit** `be41fd2` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 1897 (shared 79, api 1007, web 811). **Es una cota inferior, no lo
