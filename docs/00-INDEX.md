...
>
> - **Generado sobre el commit** `2fd4e2e` **(rama `main`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2412 (shared 163, api 1213, web 1036). **Es una cota inferior, no lo
