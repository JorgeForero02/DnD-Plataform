...
>
> - **Generado sobre el commit** `1188842` **(rama `3a2/elegir-lanzar-y-usar`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 3339 (shared 232, api 1625, web 1482). **Es una cota inferior, no lo
