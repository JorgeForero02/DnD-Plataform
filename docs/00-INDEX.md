...
>
> - **Generado sobre el commit** `1c30fe8` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2790 (shared 192, api 1354, web 1244). **Es una cota inferior, no lo
