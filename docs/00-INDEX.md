...
>
> - **Generado sobre el commit** `2bf1a85` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2768 (shared 192, api 1354, web 1222). **Es una cota inferior, no lo
