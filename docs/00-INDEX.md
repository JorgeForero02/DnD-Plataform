...
>
> - **Generado sobre el commit** `12af590` **(rama `pulido/antes-del-paso-3`)** — instantánea de la
...
> - **Declaraciones de prueba unitaria:** 2813 (shared 192, api 1357, web 1264). **Es una cota inferior, no lo
